  ...
  public void onManagerConnected(int status) {
    switch (status) {
      ...
      case LoaderCallbackInterface.INSTALL_CANCELED:
        ...
        break;
        /**
         * Application is incompatible with this version of OpenCV Manager. Possibly, a service
         * update is required. *
         */
