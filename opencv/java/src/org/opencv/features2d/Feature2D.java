...
public class Feature2D extends Algorithm {
  ...
  //
  // C++:  void cv::Feature2D::compute(vector_Mat images, vector_vector_KeyPoint& keypoints,
   ...
   *
   * @param image Image.
   * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is a
   ...
   * @param image Image.
   * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is a
   *     set of keypoints detected in images[i] . matrix with non-zero values in the region of
   *     interest.
   */
  ...
  //
  // C++:  void cv::Feature2D::detect(vector_Mat images, vector_vector_KeyPoint& keypoints,
   ...
   * @param images Image set.
   * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is a
   *     set of keypoints detected in images[i] . masks[i] is a mask for images[i].
   */
  ...
  //
  // C++:  void cv::Feature2D::detectAndCompute(Mat image, Mat mask, vector_KeyPoint& keypoints,
  ...
  public void detectAndCompute(
      Mat image, Mat mask, MatOfKeyPoint keypoints, Mat descriptors, boolean useProvidedKeypoints) {
    Mat keypoints_mat = keypoints;
    detectAndCompute_0(
        nativeObj,
        image.nativeObj,
  ...
  public void detectAndCompute(Mat image, Mat mask, MatOfKeyPoint keypoints, Mat descriptors) {
    Mat keypoints_mat = keypoints;
    detectAndCompute_1(
        nativeObj, image.nativeObj, mask.nativeObj, keypoints_mat.nativeObj, descriptors.nativeObj);
  }
  ...
  private static native void detect_0(
      long nativeObj, long image_nativeObj, long keypoints_mat_nativeObj, long mask_nativeObj);

  private static native void detect_1(
      long nativeObj, long image_nativeObj, long keypoints_mat_nativeObj);
  ...
  private static native void detect_3(
      long nativeObj, long images_mat_nativeObj, long keypoints_mat_nativeObj);

  // C++:  void cv::Feature2D::detectAndCompute(Mat image, Mat mask, vector_KeyPoint& keypoints,
  // Mat& descriptors, bool useProvidedKeypoints = false)
  private static native void detectAndCompute_0(
      long nativeObj,
      long image_nativeObj,
      long mask_nativeObj,
      long keypoints_mat_nativeObj,
  ...
  private static native void detectAndCompute_1(
      long nativeObj,
      long image_nativeObj,
      long mask_nativeObj,
      long keypoints_mat_nativeObj,
