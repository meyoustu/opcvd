 ...
 *
 * <p>DetectionModel allows to set params for preprocessing input image. DetectionModel creates net
...
public class DetectionModel extends Model {
  ...
  /**
   * Create detection model from network represented in one of the supported formats. An order of
   * {@code model} and {@code config} arguments does not matter.
   *
  ...
  //
  // C++:  void cv::dnn::DetectionModel::detect(Mat frame, vector_int& classIds, vector_float&
  // confidences, vector_Rect& boxes, float confThreshold = 0.5f, float nmsThreshold = 0.0f)
  //
  ...
  public void detect(
    ...
    detect_0(
        nativeObj,
        frame.nativeObj,
        classIds_mat.nativeObj,
        confidences_mat.nativeObj,
        boxes_mat.nativeObj,
        confThreshold,
        nmsThreshold);
  }
   ...
   */
  public void detect(
      Mat frame, MatOfInt classIds, MatOfFloat confidences, MatOfRect boxes, float confThreshold) {
    Mat classIds_mat = classIds;
    Mat confidences_mat = confidences;
    Mat boxes_mat = boxes;
    detect_1(
  ...
  private static native void detect_0(
      long nativeObj,
      long frame_nativeObj,
      long classIds_mat_nativeObj,
      long confidences_mat_nativeObj,
      long boxes_mat_nativeObj,
      float confThreshold,
      float nmsThreshold);
