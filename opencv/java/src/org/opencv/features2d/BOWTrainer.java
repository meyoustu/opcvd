 ...
 *
 * <p>For details, see, for example, *Visual Categorization with Bags of Keypoints* by Gabriella
 * Csurka, Christopher R. Dance, Lixin Fan, Jutta Willamowski, Cedric Bray, 2004. :
 */
public class BOWTrainer {
   ...
   *     <p>The vocabulary consists of cluster centers. So, this method returns the vocabulary. In
   *     the first variant of the method, train descriptors stored in the object are clustered. In
   *     the second variant, input descriptors are clustered.
   ...
   *
   * @param descriptors Descriptors to add to a training set. Each row of the descriptors matrix is
   *     a descriptor.
   *     <p>The training set is clustered using clustermethod to construct the vocabulary.
   */
