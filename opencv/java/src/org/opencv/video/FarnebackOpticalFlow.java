...
public class FarnebackOpticalFlow extends DenseOpticalFlow {
  ...
  //
  // C++: static Ptr_FarnebackOpticalFlow cv::FarnebackOpticalFlow::create(int numLevels = 5, double
  // pyrScale = 0.5, bool fastPyramids = false, int winSize = 13, int numIters = 10, int polyN = 5,
  ...
  public static FarnebackOpticalFlow create(
    ...
    return FarnebackOpticalFlow.__fromPtr__(
        create_0(numLevels, pyrScale, fastPyramids, winSize, numIters, polyN, polySigma, flags));
  }
  ...
  public static FarnebackOpticalFlow create(
      int numLevels, double pyrScale, boolean fastPyramids, int winSize, int numIters, int polyN) {
    return FarnebackOpticalFlow.__fromPtr__(
