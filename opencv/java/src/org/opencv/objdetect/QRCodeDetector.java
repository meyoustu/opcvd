...
/**
 * Groups the object candidate rectangles. rectList Input/output vector of rectangles. Output vector
 * includes retained and grouped rectangles. (The Python list is not modified in place.) weights
 * Input/output vector of weights of rectangles. Output vector includes weights of retained and
 * grouped rectangles. (The Python list is not modified in place.) groupThreshold Minimum possible
 * number of rectangles minus 1. The threshold is used in a group of rectangles to retain it. eps
...
public class QRCodeDetector {
  ...
  //
  // C++:  bool cv::QRCodeDetector::decodeMulti(Mat img, Mat points, vector_string& decoded_info,
  // vector_Mat& straight_qrcode = vector_Mat())
  //
   ...
   * @param decoded_info UTF8-encoded output vector of string or empty vector of string if the codes
   *     cannot be decoded.
   * @param points vector of Quadrangle vertices found by detect() method (or some other algorithm).
   * @param straight_qrcode The optional output vector of images containing rectified and binarized
   *     QR codes
   * @return automatically generated
   */
  public boolean decodeMulti(
      Mat img, Mat points, List<String> decoded_info, List<Mat> straight_qrcode) {
  ...
  //
  // C++:  bool cv::QRCodeDetector::detectAndDecodeMulti(Mat img, vector_string& decoded_info, Mat&
  // points = Mat(), vector_Mat& straight_qrcode = vector_Mat())
  //
   ...
   * @param decoded_info UTF8-encoded output vector of string or empty vector of string if the codes
   *     cannot be decoded.
   * @param points optional output vector of vertices of the found QR code quadrangles. Will be
   *     empty if not found.
   * @param straight_qrcode The optional output vector of images containing rectified and binarized
   *     QR codes
   * @return automatically generated
   */
  public boolean detectAndDecodeMulti(
      Mat img, List<String> decoded_info, Mat points, List<Mat> straight_qrcode) {
    Mat straight_qrcode_mat = new Mat();
    boolean retVal =
        detectAndDecodeMulti_0(
            nativeObj,
            img.nativeObj,
            decoded_info,
            points.nativeObj,
   ...
   * @param points Output vector of vector of vertices of the minimum-area quadrangle containing the
   *     codes.
   * @return automatically generated
   */
   ...
   *
   * <p>Returns UTF8-encoded output string or empty string if the code cannot be decoded.
   *
  ...
  //
  // C++:  string cv::QRCodeDetector::detectAndDecode(Mat img, Mat& points = Mat(), Mat&
  // straight_qrcode = Mat())
  //
   ...
   *
   * @param img grayscale or color (BGR) image containing QR code.
   * @param points optional output array of vertices of the found QR code quadrangle. Will be empty
   *     if not found.
   * @param straight_qrcode The optional output image containing rectified and binarized QR code
   * @return automatically generated
   */
   ...
   *
   * @param epsX Epsilon neighborhood, which allows you to determine the horizontal pattern of the
   *     scheme 1:1:3:1:1 according to QR code standard.
   */
   ...
   *
   * @param epsY Epsilon neighborhood, which allows you to determine the vertical pattern of the
   *     scheme 1:1:3:1:1 according to QR code standard.
   */
  ...
  // C++:  bool cv::QRCodeDetector::decodeMulti(Mat img, Mat points, vector_string& decoded_info,
  // vector_Mat& straight_qrcode = vector_Mat())
  private static native boolean decodeMulti_0(
      long nativeObj,
      long img_nativeObj,
      long points_nativeObj,
      List<String> decoded_info,
      long straight_qrcode_mat_nativeObj);

  private static native boolean decodeMulti_1(
      long nativeObj, long img_nativeObj, long points_nativeObj, List<String> decoded_info);
  ...
  // C++:  bool cv::QRCodeDetector::detectAndDecodeMulti(Mat img, vector_string& decoded_info, Mat&
  // points = Mat(), vector_Mat& straight_qrcode = vector_Mat())
  private static native boolean detectAndDecodeMulti_0(
      long nativeObj,
      long img_nativeObj,
      List<String> decoded_info,
      long points_nativeObj,
  ...
  private static native boolean detectAndDecodeMulti_1(
      long nativeObj, long img_nativeObj, List<String> decoded_info, long points_nativeObj);

  private static native boolean detectAndDecodeMulti_2(
      long nativeObj, long img_nativeObj, List<String> decoded_info);

  // C++:  bool cv::QRCodeDetector::detectMulti(Mat img, Mat& points)
  private static native boolean detectMulti_0(
      long nativeObj, long img_nativeObj, long points_nativeObj);

  // C++:  string cv::QRCodeDetector::decode(Mat img, Mat points, Mat& straight_qrcode = Mat())
  private static native String decode_0(
      long nativeObj, long img_nativeObj, long points_nativeObj, long straight_qrcode_nativeObj);

  private static native String decode_1(long nativeObj, long img_nativeObj, long points_nativeObj);

  // C++:  string cv::QRCodeDetector::detectAndDecode(Mat img, Mat& points = Mat(), Mat&
  // straight_qrcode = Mat())
  private static native String detectAndDecode_0(
      long nativeObj, long img_nativeObj, long points_nativeObj, long straight_qrcode_nativeObj);

  private static native String detectAndDecode_1(
      long nativeObj, long img_nativeObj, long points_nativeObj);
