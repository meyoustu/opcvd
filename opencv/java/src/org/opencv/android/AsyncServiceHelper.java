...
class AsyncServiceHelper {
  public static boolean initOpenCV(
      String Version, final Context AppContext, final LoaderCallbackInterface Callback) {
  ...
  protected AsyncServiceHelper(
      String Version, Context AppContext, LoaderCallbackInterface Callback) {
  ...
  protected static void InstallService(
    ...
    if (!mServiceInstallationProgress) {
      ...
      InstallCallbackInterface InstallQuery =
          new InstallCallbackInterface() {
      ...
      InstallCallbackInterface WaitQuery =
          new InstallCallbackInterface() {
            private LoaderCallbackInterface mUserAppCallback = Callback;
      ...
      new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
          ...
          if (null == mEngineService) {
            Log.d(
                TAG, "OpenCV Manager Service connection fails. May be service was not installed?");
                      ...
                      new InstallCallbackInterface() {
                        ...
                        public void install() {
                          ...
                          try {
                            ...
                            Log.d(
                                TAG,
                                "Init finished with status " + LoaderCallbackInterface.INIT_FAILED);
                            Log.d(TAG, "Unbind from service");
                            mAppContext.unbindService(mServiceConnection);
                            Log.d(TAG, "Calling using callback");
                            mUserAppCallback.onManagerConnected(
