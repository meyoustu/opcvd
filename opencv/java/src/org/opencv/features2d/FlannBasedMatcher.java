 ...
 *
 * <p>This matcher trains cv::flann::Index on a train descriptor collection and calls its nearest
 * search methods to find the best matches. So, this matcher may be faster when matching a large
 * train collection than the brute force matcher. FlannBasedMatcher does not support masking
...
public class FlannBasedMatcher extends DescriptorMatcher {
  ...
  //
  // C++:   cv::FlannBasedMatcher::FlannBasedMatcher(Ptr_flann_IndexParams indexParams =
  // makePtr<flann::KDTreeIndexParams>(), Ptr_flann_SearchParams searchParams =
