...
public class Photo {
   ...
   *
   * @param max_bits logarithm to the base 2 of maximal shift in each dimension. Values of 5 and 6
   *     are usually good enough (31 and 63 pixels shift respectively).
   * @param exclude_range range for exclusion bitmap that is constructed to suppress noise around
   *     the median value.
   ...
   *
   * @param max_bits logarithm to the base 2 of maximal shift in each dimension. Values of 5 and 6
   *     are usually good enough (31 and 63 pixels shift respectively). median value.
   * @return automatically generated
   */
   ...
   * Creates AlignMTB object
   *
   * <p>usually good enough (31 and 63 pixels shift respectively). median value.
   *
   * @return automatically generated
   */
  ...
  //
  // C++:  Ptr_CalibrateDebevec cv::createCalibrateDebevec(int samples = 70, float lambda = 10.0f,
  // bool random = false)
  //
   ...
   * @param lambda smoothness term weight. Greater values produce smoother results, but can alter
   *     the response.
   ...
   * Creates CalibrateDebevec object
   *
   * @param samples number of pixel locations to use response. rectangular grid.
   * @return automatically generated
   */
  ...
  //
  // C++:  Ptr_CalibrateRobertson cv::createCalibrateRobertson(int max_iter = 30, float threshold =
  // 0.01f)
  //
  ...
  //
  // C++:  Ptr_MergeMertens cv::createMergeMertens(float contrast_weight = 1.0f, float
  // saturation_weight = 1.0f, float exposure_weight = 0.0f)
  //
  ...
  public static MergeMertens createMergeMertens(
    ...
    return MergeMertens.__fromPtr__(
   ...
   *
   * @param gamma positive value for gamma correction. Gamma value of 1.0 implies no correction,
   *     gamma equal to 2.2f is suitable for most displays. Generally gamma &gt; 1 brightens the
   *     image and gamma &lt; 1 darkens it.
   * @return automatically generated
   */
   ...
   * Creates simple linear mapper with gamma correction
   *
   * <p>equal to 2.2f is suitable for most displays. Generally gamma &gt; 1 brightens the image and
   * gamma &lt; 1 darkens it.
   *
   * @return automatically generated
   */
  ...
  //
  // C++:  Ptr_TonemapDrago cv::createTonemapDrago(float gamma = 1.0f, float saturation = 1.0f,
  // float bias = 0.85f)
  //
   ...
   * @param saturation positive saturation enhancement value. 1.0 preserves saturation, values
   *     greater than 1 increase saturation and values less than 1 decrease it.
   ...
   * @param gamma gamma value for gamma correction. See createTonemap
   * @param saturation positive saturation enhancement value. 1.0 preserves saturation, values
   *     greater than 1 increase saturation and values less than 1 decrease it. results, default
   *     value is 0.85.
   * @return automatically generated
   */
   ...
   * Creates TonemapDrago object
   *
   * @param gamma gamma value for gamma correction. See createTonemap than 1 increase saturation and
   *     values less than 1 decrease it. results, default value is 0.85.
   * @return automatically generated
   */
   ...
   * Creates TonemapDrago object
   *
   * <p>than 1 increase saturation and values less than 1 decrease it. results, default value is
   * 0.85.
   *
   * @return automatically generated
   */
  ...
  //
  // C++:  Ptr_TonemapMantiuk cv::createTonemapMantiuk(float gamma = 1.0f, float scale = 0.7f, float
  // saturation = 1.0f)
  //
   ...
   *
   * @param gamma gamma value for gamma correction. See createTonemap
   * @param scale contrast scale factor. HVS response is multiplied by this parameter, thus
   *     compressing dynamic range. Values from 0.6 to 0.9 produce best results.
   ...
   * Creates TonemapMantiuk object
   *
   * @param gamma gamma value for gamma correction. See createTonemap dynamic range. Values from 0.6
   ...
   * Creates TonemapMantiuk object
   *
   * <p>dynamic range. Values from 0.6 to 0.9 produce best results.
   *
   * @return automatically generated
   */
  ...
  //
  // C++:  Ptr_TonemapReinhard cv::createTonemapReinhard(float gamma = 1.0f, float intensity = 0.0f,
   ...
   *
   * @param gamma gamma value for gamma correction. See createTonemap
   * @param intensity result intensity in [-8, 8] range. Greater intensity produces brighter
   *     results.
   * @param light_adapt light adaptation in [0, 1] range. If 1 adaptation is based only on pixel
   *     value, if 0 it's global, otherwise it's a weighted mean of this two cases.
   * @param color_adapt chromatic adaptation in [0, 1] range. If 1 channels are treated
   *     independently, if 0 adaptation level is the same for each channel.
   * @return automatically generated
   */
  public static TonemapReinhard createTonemapReinhard(
      float gamma, float intensity, float light_adapt, float color_adapt) {
    return TonemapReinhard.__fromPtr__(
   ...
   *     results.
   * @param light_adapt light adaptation in [0, 1] range. If 1 adaptation is based only on pixel
   *     value, if 0 it's global, otherwise it's a weighted mean of this two cases. if 0 adaptation
   *     level is the same for each channel.
   * @return automatically generated
   */
  public static TonemapReinhard createTonemapReinhard(
   ...
   * @param gamma gamma value for gamma correction. See createTonemap
   * @param intensity result intensity in [-8, 8] range. Greater intensity produces brighter
   *     results. value, if 0 it's global, otherwise it's a weighted mean of this two cases. if 0
   *     adaptation level is the same for each channel.
   * @return automatically generated
   */
   ...
   * Creates TonemapReinhard object
   *
   * @param gamma gamma value for gamma correction. See createTonemap value, if 0 it's global,
   *     otherwise it's a weighted mean of this two cases. if 0 adaptation level is the same for
   *     each channel.
   * @return automatically generated
   */
   ...
   * Creates TonemapReinhard object
   *
   * <p>value, if 0 it's global, otherwise it's a weighted mean of this two cases. if 0 adaptation
   * level is the same for each channel.
   *
   * @return automatically generated
   */
   ...
   * grayscale images or for manual manipulation with colorspaces. For more details see
   ...
   * deformations) or local changes concerned to a selection. Here we are interested in achieving
   * local changes, ones that are restricted to a region manually selected (ROI), in a seamless and
   * effortless manner. The extent of the changes ranges from slight distortions to complete
   * replacement by novel content CITE: PM03 .
   *
   * @param src Input 8-bit 3-channel image.
  ...
  // C++:  Ptr_MergeMertens cv::createMergeMertens(float contrast_weight = 1.0f, float
  // saturation_weight = 1.0f, float exposure_weight = 0.0f)
  private static native long createMergeMertens_0(
      float contrast_weight, float saturation_weight, float exposure_weight);
  ...
  // C++:  Ptr_TonemapReinhard cv::createTonemapReinhard(float gamma = 1.0f, float intensity = 0.0f,
  // float light_adapt = 1.0f, float color_adapt = 0.0f)
  private static native long createTonemapReinhard_0(
      float gamma, float intensity, float light_adapt, float color_adapt);
