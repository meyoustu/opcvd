...
namespace cv {
    namespace util {
        ...
        class variant {
            ...
            static constexpr std::array<VCtr, sizeof...(Ts)>
            vctrs() { return {{(&vctr_h<Ts>::help)...}}; }
        ...
        public:
            ...
            template<typename T>
            explicit variant(T &&t, typename detail::are_different<variant, T, int>::type = 0);
        ...
        variant<Ts...>::variant(T &&t, typename detail::are_different<variant, T, int>::type)
                : m_index(
                util::type_list_index<typename std::remove_reference<T>::type, Ts...>::value) {
        ...
        template<typename... Ts>
        template<class T>
        typename detail::are_different<variant<Ts...>, T, variant<Ts...> &>
