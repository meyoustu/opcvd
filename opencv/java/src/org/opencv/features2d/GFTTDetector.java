...
public class GFTTDetector extends Feature2D {
  ...
  //
  // C++: static Ptr_GFTTDetector cv::GFTTDetector::create(int maxCorners, double qualityLevel,
  // double minDistance, int blockSize, int gradiantSize, bool useHarrisDetector = false, double k =
  // 0.04)
  //
  ...
  public static GFTTDetector create(
      ...
      double k) {
    return GFTTDetector.__fromPtr__(
        create_0(
  ...
  public static GFTTDetector create(
    ...
    return GFTTDetector.__fromPtr__(
        create_1(
            maxCorners, qualityLevel, minDistance, blockSize, gradiantSize, useHarrisDetector));
  }

  public static GFTTDetector create(
      int maxCorners, double qualityLevel, double minDistance, int blockSize, int gradiantSize) {
    return GFTTDetector.__fromPtr__(
        create_2(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize));
  }

  //
  // C++: static Ptr_GFTTDetector cv::GFTTDetector::create(int maxCorners = 1000, double
  // qualityLevel = 0.01, double minDistance = 1, int blockSize = 3, bool useHarrisDetector = false,
  // double k = 0.04)
  //
  ...
  public static GFTTDetector create(
      ...
      double k) {
    return GFTTDetector.__fromPtr__(
        create_3(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector, k));
  }
  ...
  public static GFTTDetector create(
      ...
      boolean useHarrisDetector) {
    return GFTTDetector.__fromPtr__(
        create_4(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector));
  }
