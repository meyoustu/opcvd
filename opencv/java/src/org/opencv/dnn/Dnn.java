...
public class Dnn {
  ...
  //
  // C++:  Mat cv::dnn::blobFromImage(Mat image, double scalefactor = 1.0, Size size = Size(),
  // Scalar mean = Scalar(), bool swapRB = false, bool crop = false, int ddepth = CV_32F)
  //
   ...
   * @param mean scalar with mean values which are subtracted from channels. Values are intended to
   *     be in (mean-R, mean-G, mean-B) order if {@code image} has BGR ordering and {@code swapRB}
   *     is true.
   ...
   * @param ddepth Depth of output blob. Choose CV_32F or CV_8U. if {@code crop} is true, input
   *     image is resized so one side after resize is equal to corresponding dimension in {@code
   *     size} and another one is equal or larger. Then, crop from the center is performed. If
   *     {@code crop} is false, direct resize without cropping and preserving aspect ratio is
   *     performed.
   ...
   * @param swapRB flag which indicates that swap first and last channels in 3-channel image is
   *     necessary.
   * @param crop flag which indicates whether image will be cropped after resize or not if {@code
   *     crop} is true, input image is resized so one side after resize is equal to corresponding
   *     dimension in {@code size} and another one is equal or larger. Then, crop from the center is
   *     performed. If {@code crop} is false, direct resize without cropping and preserving aspect
   *     ratio is performed.
   * @return 4-dimensional Mat with NCHW dimensions order.
   */
  public static Mat blobFromImage(
      Mat image, double scalefactor, Size size, Scalar mean, boolean swapRB, boolean crop) {
    return new Mat(
        blobFromImage_1(
            image.nativeObj,
            scalefactor,
   ...
   * @param scalefactor multiplier for {@code image} values.
   * @param swapRB flag which indicates that swap first and last channels in 3-channel image is
   *     necessary. if {@code crop} is true, input image is resized so one side after resize is
   *     equal to corresponding dimension in {@code size} and another one is equal or larger. Then,
   *     crop from the center is performed. If {@code crop} is false, direct resize without cropping
   *     and preserving aspect ratio is performed.
   * @return 4-dimensional Mat with NCHW dimensions order.
   */
  public static Mat blobFromImage(
      Mat image, double scalefactor, Size size, Scalar mean, boolean swapRB) {
    return new Mat(
        blobFromImage_2(
            image.nativeObj,
            scalefactor,
   ...
   *     be in (mean-R, mean-G, mean-B) order if {@code image} has BGR ordering and {@code swapRB}
   *     is true.
   * @param scalefactor multiplier for {@code image} values. in 3-channel image is necessary. if
   *     {@code crop} is true, input image is resized so one side after resize is equal to
   *     corresponding dimension in {@code size} and another one is equal or larger. Then, crop from
   *     the center is performed. If {@code crop} is false, direct resize without cropping and
   ...
   *
   * @param image input image (with 1-, 3- or 4-channels).
   * @param size spatial size for output image to be in (mean-R, mean-G, mean-B) order if {@code
   *     image} has BGR ordering and {@code swapRB} is true.
   * @param scalefactor multiplier for {@code image} values. in 3-channel image is necessary. if
   *     {@code crop} is true, input image is resized so one side after resize is equal to
   *     corresponding dimension in {@code size} and another one is equal or larger. Then, crop from
   *     the center is performed. If {@code crop} is false, direct resize without cropping and
   ...
   * subtract {@code mean} values, scales values by {@code scalefactor}, swap Blue and Red channels.
   *
   * @param image input image (with 1-, 3- or 4-channels). to be in (mean-R, mean-G, mean-B) order
   *     if {@code image} has BGR ordering and {@code swapRB} is true.
   * @param scalefactor multiplier for {@code image} values. in 3-channel image is necessary. if
   *     {@code crop} is true, input image is resized so one side after resize is equal to
   *     corresponding dimension in {@code size} and another one is equal or larger. Then, crop from
   *     the center is performed. If {@code crop} is false, direct resize without cropping and
   ...
   *
   * @param image input image (with 1-, 3- or 4-channels). to be in (mean-R, mean-G, mean-B) order
   *     if {@code image} has BGR ordering and {@code swapRB} is true. in 3-channel image is
   *     necessary. if {@code crop} is true, input image is resized so one side after resize is
   *     equal to corresponding dimension in {@code size} and another one is equal or larger. Then,
   *     crop from the center is performed. If {@code crop} is false, direct resize without cropping
   *     and preserving aspect ratio is performed.
  ...
  //
  // C++:  Mat cv::dnn::blobFromImages(vector_Mat images, double scalefactor = 1.0, Size size =
  // Size(), Scalar mean = Scalar(), bool swapRB = false, bool crop = false, int ddepth = CV_32F)
  //

  /**
   * Creates 4-dimensional blob from series of images. Optionally resizes and crops {@code images}
   * from center, subtract {@code mean} values, scales values by {@code scalefactor}, swap Blue and
   * Red channels.
   *
   ...
   */
  public static Mat blobFromImages(
      List<Mat> images, double scalefactor, Size size, Scalar mean, boolean swapRB, boolean crop) {
    Mat images_mat = Converters.vector_Mat_to_Mat(images);
    return new Mat(
        blobFromImages_1(
            images_mat.nativeObj,
   ...
   */
  public static Mat blobFromImages(
      List<Mat> images, double scalefactor, Size size, Scalar mean, boolean swapRB) {
    Mat images_mat = Converters.vector_Mat_to_Mat(images);
    return new Mat(
        blobFromImages_2(
            images_mat.nativeObj,
   ...
   *     be in (mean-R, mean-G, mean-B) order if {@code image} has BGR ordering and {@code swapRB}
   *     is true.
   * @param scalefactor multiplier for {@code images} values. in 3-channel image is necessary. if
   *     {@code crop} is true, input image is resized so one side after resize is equal to
   *     corresponding dimension in {@code size} and another one is equal or larger. Then, crop from
   *     the center is performed. If {@code crop} is false, direct resize without cropping and
   *     preserving aspect ratio is performed.
   ...
   * Red channels.
   *
   * @param images input images (all with 1-, 3- or 4-channels). to be in (mean-R, mean-G, mean-B)
   *     order if {@code image} has BGR ordering and {@code swapRB} is true.
   * @param scalefactor multiplier for {@code images} values. in 3-channel image is necessary. if
   *     {@code crop} is true, input image is resized so one side after resize is equal to
   *     corresponding dimension in {@code size} and another one is equal or larger. Then, crop from
   *     the center is performed. If {@code crop} is false, direct resize without cropping and
   ...
   *
   * @param images input images (all with 1-, 3- or 4-channels). to be in (mean-R, mean-G, mean-B)
   *     order if {@code image} has BGR ordering and {@code swapRB} is true. in 3-channel image is
   *     necessary. if {@code crop} is true, input image is resized so one side after resize is
   *     equal to corresponding dimension in {@code size} and another one is equal or larger. Then,
   *     crop from the center is performed. If {@code crop} is false, direct resize without cropping
   *     and preserving aspect ratio is performed.
  ...
  /**
   * Loads blob which was serialized as torch.Tensor object of Torch7 framework. WARNING: This
   * function has the same limitations as readNetFromTorch().
   *
  ...
  //
  // C++:  Net cv::dnn::readNet(String framework, vector_uchar bufferModel, vector_uchar
  // bufferConfig = std::vector<uchar>())
  //

  /**
   * Read deep learning network represented in one of the supported formats. This is an overloaded
   ...
   *
   * @param model Binary file contains trained weights. The following file extensions are expected
   *     for models from different frameworks: * {@code *.caffemodel} (Caffe,
   *     http://caffe.berkeleyvision.org/) * {@code *.pb} (TensorFlow, https://www.tensorflow.org/)
   *     * {@code *.t7} | {@code *.net} (Torch, http://torch.ch/) * {@code *.weights} (Darknet,
   *     https://pjreddie.com/darknet/) * {@code *.bin} (DLDT,
   *     https://software.intel.com/openvino-toolkit) * {@code *.onnx} (ONNX, https://onnx.ai/)
   * @param config Text file contains network configuration. It could be a file with the following
   *     extensions: * {@code *.prototxt} (Caffe, http://caffe.berkeleyvision.org/) * {@code
   *     *.pbtxt} (TensorFlow, https://www.tensorflow.org/) * {@code *.cfg} (Darknet,
   *     https://pjreddie.com/darknet/) * {@code *.xml} (DLDT,
   *     https://software.intel.com/openvino-toolkit)
   * @param framework Explicit framework name tag to determine a format.
   * @return Net object.
   *     <p>This function automatically detects an origin framework of trained model and calls an
   *     appropriate function such REF: readNetFromCaffe, REF: readNetFromTensorflow, REF:
   *     readNetFromTorch or REF: readNetFromDarknet. An order of {@code model} and {@code config}
   ...
   *     * {@code *.t7} | {@code *.net} (Torch, http://torch.ch/) * {@code *.weights} (Darknet,
   *     https://pjreddie.com/darknet/) * {@code *.bin} (DLDT,
   *     https://software.intel.com/openvino-toolkit) * {@code *.onnx} (ONNX, https://onnx.ai/) file
   *     with the following extensions: * {@code *.prototxt} (Caffe,
   *     http://caffe.berkeleyvision.org/) * {@code *.pbtxt} (TensorFlow,
   *     https://www.tensorflow.org/) * {@code *.cfg} (Darknet, https://pjreddie.com/darknet/) *
  ...
  /**
   * Reads a network model stored in &lt;a href="http://caffe.berkeleyvision.org"&gt;Caffe&lt;/a&gt;
   * framework's format.
   *
  ...
  //
  // C++:  Net cv::dnn::readNetFromCaffe(vector_uchar bufferProto, vector_uchar bufferModel =
  // std::vector<uchar>())
  //
  ...
  /**
   * Reads a network model stored in &lt;a href="https://pjreddie.com/darknet/"&gt;Darknet&lt;/a&gt;
   * model files.
   *
  ...
  //
  // C++:  Net cv::dnn::readNetFromDarknet(vector_uchar bufferCfg, vector_uchar bufferModel =
  // std::vector<uchar>())
  //
   ...
   * @return Net object. Networks imported from Intel's Model Optimizer are launched in Intel's
  ...
  //
  // C++:  Net cv::dnn::readNetFromModelOptimizer(vector_uchar bufferModelConfig, vector_uchar
  // bufferWeights)
  //
  ...
  public static Net readNetFromModelOptimizer(
      MatOfByte bufferModelConfig, MatOfByte bufferWeights) {
    Mat bufferModelConfig_mat = bufferModelConfig;
    Mat bufferWeights_mat = bufferWeights;
    return new Net(
        readNetFromModelOptimizer_1(bufferModelConfig_mat.nativeObj, bufferWeights_mat.nativeObj));
  }
  ...
  /**
   * Reads a network model stored in &lt;a
   * href="https://www.tensorflow.org/"&gt;TensorFlow&lt;/a&gt; framework's format.
   *
   * @param model path to the .pb file with binary protobuf description of the network architecture
   * @param config path to the .pbtxt file that contains text graph definition in protobuf format.
   *     Resulting Net object is built by text graph using weights from a binary one that let us
  ...
  //
  // C++:  Net cv::dnn::readNetFromTensorflow(vector_uchar bufferModel, vector_uchar bufferConfig =
  // std::vector<uchar>())
  //
  ...
  /**
   * Reads a network model stored in &lt;a href="http://torch.ch"&gt;Torch7&lt;/a&gt; framework's
   * format.
   *
   * @param model path to the file, dumped from Torch by using torch.save() function.
   * @param isBinary specifies whether the network was serialized in ascii mode or binary.
   * @param evaluate specifies testing phase of network. If true, it's similar to evaluate() method
   *     in Torch.
   * @return Net object.
   *     <p><b>Note:</b> Ascii mode of Torch serializer is more preferable, because binary mode
   *     extensively use {@code long} type of C language, which has various bit-length on different
   *     systems.
   *     <p>The loading file must contain serialized &lt;a
   *     href="https://github.com/torch/nn/blob/master/doc/module.md"&gt;nn.Module&lt;/a&gt; object
   *     with importing network. Try to eliminate a custom objects from serialazing data to avoid
   *     importing errors.
   *     <p>List of supported layers (i.e. object instances derived from Torch nn.Module class): -
   *     nn.Sequential - nn.Parallel - nn.Concat - nn.Linear - nn.SpatialConvolution -
   *     nn.SpatialMaxPooling, nn.SpatialAveragePooling - nn.ReLU, nn.TanH, nn.Sigmoid - nn.Reshape
   *     - nn.SoftMax, nn.LogSoftMax
   *     <p>Also some equivalents of these classes from cunn, cudnn, and fbcunn may be successfully
   *     imported.
   */
   ...
   *
   * <p>See values of {@code CV_DNN_BACKEND_INFERENCE_ENGINE_*} macros.
   *
   * <p>Default value is controlled through {@code OPENCV_DNN_BACKEND_INFERENCE_ENGINE_TYPE} runtime
   ...
   *
   * <p>See values of {@code CV_DNN_INFERENCE_ENGINE_VPU_TYPE_*} macros.
   *
   * @return automatically generated
   */
  ...
  //
  // C++:  void cv::dnn::NMSBoxes(vector_Rect2d bboxes, vector_float scores, float score_threshold,
  // float nms_threshold, vector_int& indices, float eta = 1.f, int top_k = 0)
  //
  ...
  public static void NMSBoxes(
    ...
    NMSBoxes_0(
        bboxes_mat.nativeObj,
        scores_mat.nativeObj,
        score_threshold,
        nms_threshold,
        indices_mat.nativeObj,
        eta,
        top_k);
  }
  ...
  //
  // C++:  void cv::dnn::NMSBoxes(vector_RotatedRect bboxes, vector_float scores, float
  // score_threshold, float nms_threshold, vector_int& indices, float eta = 1.f, int top_k = 0)
  //

  public static void NMSBoxesRotated(
      MatOfRotatedRect bboxes,
      MatOfFloat scores,
      float score_threshold,
      float nms_threshold,
      MatOfInt indices,
   ...
   *     precision (CV_32F). They are non normalized neither mean added. The number of returned
   *     images equals the first dimension of the blob (batch size). Every image has a number of
   *     channels equals to the second dimension of the blob (depth).
   */
   ...
   *
   * <p>Single Myriad device cannot be shared across multiple processes which uses Inference
   * Engine's Myriad plugin.
   */
  ...
  //
  // C++:  void cv::dnn::shrinkCaffeModel(String src, String dst, vector_String layersTypes =
  // std::vector<String>())
  //
   ...
   *     weights (usually has {@code .caffemodel} extension).
   ...
   *     <p><b>Note:</b> Shrinked model has no origin float32 weights so it can't be used in origin
   *     Caffe framework anymore. However the structure of data is taken from NVidia's Caffe fork:
   ...
   * @param src Path to origin model from Caffe framework contains single precision floating point
   *     weights (usually has {@code .caffemodel} extension).
   * @param dst Path to destination model with updated weights. By default, converts only
   ...
   *     <p><b>Note:</b> To reduce output file size, trained weights are not included.
   */
  ...
  // C++:  Mat cv::dnn::blobFromImage(Mat image, double scalefactor = 1.0, Size size = Size(),
  // Scalar mean = Scalar(), bool swapRB = false, bool crop = false, int ddepth = CV_32F)
  private static native long blobFromImage_0(
  ...
  private static native long blobFromImage_1(
      long image_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImage_2(
      long image_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImage_3(
      long image_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImage_4(
      long image_nativeObj, double scalefactor, double size_width, double size_height);
  ...
  // C++:  Mat cv::dnn::blobFromImages(vector_Mat images, double scalefactor = 1.0, Size size =
  // Size(), Scalar mean = Scalar(), bool swapRB = false, bool crop = false, int ddepth = CV_32F)
  private static native long blobFromImages_0(
  ...
  private static native long blobFromImages_1(
      long images_mat_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImages_2(
      long images_mat_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImages_3(
      long images_mat_nativeObj,
      double scalefactor,
      double size_width,
      double size_height,
  ...
  private static native long blobFromImages_4(
      long images_mat_nativeObj, double scalefactor, double size_width, double size_height);
  ...
  // C++:  Net cv::dnn::readNet(String framework, vector_uchar bufferModel, vector_uchar
  // bufferConfig = std::vector<uchar>())
  private static native long readNet_0(
      String framework, long bufferModel_mat_nativeObj, long bufferConfig_mat_nativeObj);
  ...
  // C++:  Net cv::dnn::readNetFromCaffe(vector_uchar bufferProto, vector_uchar bufferModel =
  // std::vector<uchar>())
  private static native long readNetFromCaffe_2(
      long bufferProto_mat_nativeObj, long bufferModel_mat_nativeObj);
  ...
  // C++:  Net cv::dnn::readNetFromDarknet(vector_uchar bufferCfg, vector_uchar bufferModel =
  // std::vector<uchar>())
  private static native long readNetFromDarknet_2(
      long bufferCfg_mat_nativeObj, long bufferModel_mat_nativeObj);
  ...
  // C++:  Net cv::dnn::readNetFromModelOptimizer(vector_uchar bufferModelConfig, vector_uchar
  // bufferWeights)
  private static native long readNetFromModelOptimizer_1(
      long bufferModelConfig_mat_nativeObj, long bufferWeights_mat_nativeObj);
  ...
  // C++:  Net cv::dnn::readNetFromTensorflow(vector_uchar bufferModel, vector_uchar bufferConfig =
  // std::vector<uchar>())
  private static native long readNetFromTensorflow_2(
      long bufferModel_mat_nativeObj, long bufferConfig_mat_nativeObj);
  ...
  // C++:  void cv::dnn::NMSBoxes(vector_Rect2d bboxes, vector_float scores, float score_threshold,
  // float nms_threshold, vector_int& indices, float eta = 1.f, int top_k = 0)
  private static native void NMSBoxes_0(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
      long indices_mat_nativeObj,
      float eta,
      int top_k);

  private static native void NMSBoxes_1(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
  ...
  private static native void NMSBoxes_2(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
  ...
  // C++:  void cv::dnn::NMSBoxes(vector_RotatedRect bboxes, vector_float scores, float
  // score_threshold, float nms_threshold, vector_int& indices, float eta = 1.f, int top_k = 0)
  private static native void NMSBoxesRotated_0(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
  ...
  private static native void NMSBoxesRotated_1(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
  ...
  private static native void NMSBoxesRotated_2(
      long bboxes_mat_nativeObj,
      long scores_mat_nativeObj,
      float score_threshold,
      float nms_threshold,
