 ...
 *
 * <p>It is invariant to exposure, so exposure values and camera response are not necessary.
 *
 * <p>In this implementation new image regions are filled with zeros.
 *
 * <p>For more information see CITE: GW03 .
 */
public class AlignMTB extends AlignExposures {
  ...
  /**
   * Calculates shift between two images, i. e. how to shift the second image to correspond it with
   * the first.
   *
  ...
  // C++:  Point cv::AlignMTB::calculateShift(Mat img0, Mat img1)
  private static native double[] calculateShift_0(
      long nativeObj, long img0_nativeObj, long img1_nativeObj);
  ...
  // C++:  void cv::AlignMTB::computeBitmaps(Mat img, Mat& tb, Mat& eb)
  private static native void computeBitmaps_0(
      long nativeObj, long img_nativeObj, long tb_nativeObj, long eb_nativeObj);
  ...
  private static native void process_1(
      long nativeObj, long src_mat_nativeObj, long dst_mat_nativeObj);
  ...
  // C++:  void cv::AlignMTB::shiftMat(Mat src, Mat& dst, Point shift)
  private static native void shiftMat_0(
      long nativeObj, long src_nativeObj, long dst_nativeObj, double shift_x, double shift_y);
