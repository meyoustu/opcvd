...
public class Utils {
   ...
   *
   * <p>This function converts an Android Bitmap image to the OpenCV Mat. <br>
   * 'ARGB_8888' and 'RGB_565' input Bitmap formats are supported. <br>
   * The output Mat is always created of the same size as the input Bitmap and of the 'CV_8UC4'
   * type, it keeps the image in RGBA format. <br>
   ...
   *     from alpha premultiplied format (like Android keeps 'ARGB_8888' ones) to regular one; this
   *     flag is ignored for 'RGB_565' bitmaps.
   */
   ...
   *
   * <p><br>
   * This function converts an image in the OpenCV Mat representation to the Android Bitmap. <br>
   * The input Mat object has to be of the types 'CV_8UC1' (gray-scale), 'CV_8UC3' (RGB) or
   * 'CV_8UC4' (RGBA). <br>
   * The output Bitmap object has to be of the same size as the input Mat and of the types
   * 'ARGB_8888' or 'RGB_565'. <br>
   * This function throws an exception if the conversion fails.
   *
   ...
   *     alpha premultiplied format (like Android keeps 'ARGB_8888' bitmaps); the flag is ignored
   *     for 'RGB_565' bitmaps.
   */
