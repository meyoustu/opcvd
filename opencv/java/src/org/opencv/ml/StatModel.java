...
public class StatModel extends Algorithm {
   ...
   *     new training samples, not completely overwritten (such as NormalBayesClassifier or
   *     ANN_MLP).
   * @return automatically generated
   */
   ...
   *     <p>The method uses StatModel::predict to compute the error. For regression models the error
   *     is computed as RMS, for classifiers - as a percent of missclassified samples (0%-100%).
   * @return automatically generated
   */
  ...
  // C++:  bool cv::ml::StatModel::train(Mat samples, int layout, Mat responses)
  private static native boolean train_0(
