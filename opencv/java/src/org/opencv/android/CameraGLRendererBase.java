...
public abstract class CameraGLRendererBase
  ...
  protected abstract void setCameraPreviewSize(
      int width, int height); // updates mCameraWidth & mCameraHeight
  ...
  private void initFBO(int width, int height) {
    ...
    GLES20.glFramebufferTexture2D(
        GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, GLES20.GL_TEXTURE_2D, texFBO[0], 0);
  ...
  protected synchronized void doStart() {
    ...
    if (mCameraWidth > 0 && mCameraHeight > 0)
      setPreviewSize(
          mCameraWidth, mCameraHeight); // start preview and call listener.onCameraViewStarted()
  }
