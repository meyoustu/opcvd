 ...
 *
 * <p>SegmentationModel allows to set params for preprocessing input image. SegmentationModel
 * creates net from file with trained weights and config, sets preprocessing input, runs forward
 * pass and returns the class prediction for each pixel.
 */
public class SegmentationModel extends Model {
  ...
  /**
   * Create segmentation model from network represented in one of the supported formats. An order of
