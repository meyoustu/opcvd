 ...
 *
 * <p>KeypointsModel allows to set params for preprocessing input image. KeypointsModel creates net
 * from file with trained weights and config, sets preprocessing input, runs forward pass and
 * returns the x and y coordinates of each detected keypoint
 */
public class KeypointsModel extends Model {
  ...
  /**
   * Create keypoints model from network represented in one of the supported formats. An order of
