...
public class Boost extends DTrees {
  ...
  /**
   * Creates the empty model. Use StatModel::train to train the model,
   ...
   *
   * <p>Use Boost::save to serialize and store an RTree to disk. Load the Boost from this file
