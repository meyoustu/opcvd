 ...
 *
 * <p>The class computes passing time by counting the number of ticks per second. That is, the
 * following code computes the execution time in seconds: <code>
 * TickMeter tm;
 * tm.start();
 * // do something ...
 * tm.stop();
 * std::cout &lt;&lt; tm.getTimeSec();
 * </code> It is also possible to compute the average time over multiple runs: <code>
 * TickMeter tm;
 * for (int i = 0; i &lt; 100; i++)
 * {
 *     tm.start();
 ...
 * </code> SEE: getTickCount, getTickFrequency
 */
